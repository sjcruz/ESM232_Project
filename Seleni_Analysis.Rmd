...
ps1 <- cbind.data.frame(hx=rnorm(mean=hx, sd=0.1, n=nsample), hp=rnorm(mean=hp, sd=0.1, n=nsample), 
                       c=rnorm(mean = c, sd= 0.05, n=nsample), rx=rnorm(mean=rx, sd=0.1, n=nsample),
                       dp= rnorm(mean=dp, sd=0.1, n=nsample), X0=runif(min=15, max=100, n=nsample),
                       P0=runif(min=15, max=30, n=nsample), ax= rnorm(mean=ax, sd=0.05, n=nsample),
                       ay= rnorm(mean=ay, sd=0.05, n=nsample), Kx=runif(min=75, max=200, n=nsample),
                       Kp=runif(min=20, max=80, n=nsample), Y=runif(min=400, max=500, n=nsample)  )

ps2 <-  cbind.data.frame(hx=rnorm(mean=hx, sd=0.1, n=nsample), hp=rnorm(mean=hp, sd=0.1, n=nsample), 
                       c=rnorm(mean = c, sd= 0.05, n=nsample), rx=rnorm(mean=rx, sd=0.1, n=nsample),
                       dp= rnorm(mean=dp, sd=0.1, n=nsample), X0=runif(min=15, max=100, n=nsample),
                       P0=runif(min=15, max=30, n=nsample), ax= rnorm(mean=ax, sd=0.05, n=nsample),
                       ay= rnorm(mean=ay, sd=0.05, n=nsample), Kx=runif(min=75, max=200, n=nsample),
